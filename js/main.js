...
(function () {
  ...
  const PAGES = [
    ...
    { file: "fotografi.html", label: "Fotografi",  icon: "photo" },
    ...
    mount.innerHTML = `
      <div class="sb-brand">
        ...
        <div>
          ...
          <div class="sb-tag">showreel.mc</div>
        </div>
      </div>
  ...
  function setupLightbox() {
    ...
    lb.addEventListener("click", (e) => {
      ...
      if (e.target.closest(".lb-nav.prev")) step(-1);
      if (e.target.closest(".lb-nav.next")) step(1);
    });
    function step(dir) {
  ...
  /* ---------------- PARTICLES (cursor trail + click burst) ---------------- */
